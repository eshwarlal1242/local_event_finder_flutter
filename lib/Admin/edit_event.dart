...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  Future<void> _fetchEventDetails() async {
    try {
      ...
      await FirebaseFirestore.instance.collection('events').doc(widget.docId).get();
      if (docSnapshot.exists) {
        ...
        _base64Image = data['image_base64'];
        status = data['status'];
        setState(() {});
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Edit Event", style: TextStyle(color: white, fontWeight: FontWeight.bold)),
